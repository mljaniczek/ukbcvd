...
ggplot(all_strat_M1, aes(x = estimate, y = -log10(fdr+.05))) +
  geom_point()

gt::gt(subset_M1)%>%
  tab_header(title = "Phase I Metabolites q <0.05 and abs(estimate)>1")
...
ggplot(
  ...
  xlim(-2.5, 2.5) +
  ggtitle("Age 60-69 M vs F standardized metabolite values", subtitle = "For mx with p.adj <0.5 and abs(est)>1")
...
ggplot(
  ...
  theme(axis.text.y = element_blank(),#element_text(size = 3),
        legend.position = "bottom")+
  xlim(-2.5, 2.5) +
  ggtitle("Age 70-85 M vs F standardized metabolite values", subtitle = "For mx with p.adj <0.5 and abs(est)>1")
...
ggplot(
  ...
  theme(axis.text.y = element_blank(),#element_text(size = 3),
        legend.position = "bottom")+
  xlim(-2.5, 2.5) +
  ggtitle("Phase II Age 60-69 M vs F standardized metabolite values", subtitle = "For mx with p.adj <0.5 and abs(est)>1")
#TODO make ylim labels smaller and 
#TODO move key to bottom
...
ggplot(
  ...
  theme(axis.text.y = element_blank(),#element_text(size = 3),
        legend.position = "bottom")+
  xlim(-2.5, 2.5) +
  ggtitle("Phase II Age 70-85 M vs F standardized metabolite values", subtitle = "For mx with p.adj <0.5 and abs(est)>1")
