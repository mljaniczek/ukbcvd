...
mydat <- read.csv("hapo_metabolomics_2020.csv")
...
```{r spinglass ag1 - slide 24, message = TRUE, eval=TRUE}
plot(ggm_ag_g[["ag1"]],
...
```{r spinglass ag2 - slide 25, message = TRUE, eval=TRUE}
plot(ggm_ag_g[["ag2"]],
...
\footnotesize   
Explore the global component of the dingo graph.
```{r global - slide 42, message = TRUE, eval=TRUE}
